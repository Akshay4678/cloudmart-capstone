...
# Flask session settings are configured after the DB password helper below.
# If FLASK_SECRET_KEY is not supplied, the application derives a stable
# application-specific key from the encrypted DB password. This keeps the
# session valid across Gunicorn workers and EC2 restarts without storing a
# plain-text secret in the dashboard code.
